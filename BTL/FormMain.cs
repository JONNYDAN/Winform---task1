...
namespace BTL
{
    public partial class FormMain : Form
    {
        ...
        {
            ((Panel)sender).BackColor = Color.FromArgb(224, 224, 224);
        }

        private void panel6_MouseLeave(object sender, EventArgs e)
        {
            if(itemMenuDiemClicked==false)
            ((Panel)sender).BackColor = Color.FromArgb(255, 255, 255, 255);
        }
        //--------------------
        ...
        {
            if(itemMenuDiemClicked==false)
            panel6.BackColor = Color.FromArgb(255, 255, 255, 255);
        }
        //--------------------
        ...
        private void Item_PanelGV_Leave(object sender, EventArgs e)
        {
            ...
            panel2.BackColor = Color.FromArgb(255, 255, 255, 255);
        }
        //--------------------
        ...
        private void Item_PanelLopHC_Leave(object sender, EventArgs e)
        {
            ...
            panel8.BackColor = Color.FromArgb(255, 255, 255, 255);
        }
        //--------------------
        ...
        private void Item_PanelLopTC_Leave(object sender, EventArgs e)
        {
            ...
            panel10.BackColor = Color.FromArgb(255, 255, 255, 255);
        }
        //--------------------
        ...
        private void Item_PanelMonHoc_Leave(object sender, EventArgs e)
        {
            ...
            panel12.BackColor = Color.FromArgb(255, 255, 255, 255);
        }
        //--------------------
        ...
        private void Item_PanelSV_Leave(object sender, EventArgs e)
        {
            ...
            panel14.BackColor = Color.FromArgb(255, 255, 255, 255);
